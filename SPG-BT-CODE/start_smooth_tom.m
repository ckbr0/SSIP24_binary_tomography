%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Deterministic Smooth (gray) Tomography 
...
w_proj=0.5;               % Projection weight, suggested value: 0.1, in previous versions w_proj=const=0.5
w_hom=0;                % Homogenity weight, suggested value: 0.5
...
mu=0.000;                % Initial value of the binarization parameter
mu_delta=0.0; % 0.2
...
%%%%%% START: Parameters of the SPG Algorithm %%%%%
...
total_iterations=0; 
    ...
    while  (k<2) || (  norm( proj(Xnew-gg)-Xnew,inf) > Ein &&  k < max_SPG_it && lambda>10^(-6) ), % STOPPING CRITERION
